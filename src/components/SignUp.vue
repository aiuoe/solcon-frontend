...
export default class SignUp extends Vue {
	...
	async signup()
	{
		...
		return await axios.post('https://amable-plus.herokuapp.com/api/auth/signup', this.params).then((response: any) => { if (response['status'] === 200) this.$router.push({ path: 'login' })}).catch((error: any) => {console.log(error)})
	}
